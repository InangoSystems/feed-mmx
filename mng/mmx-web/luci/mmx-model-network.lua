...
-- This file is modified by Inango.
-- Original file location in built image /usr/lib/lua/luci/model/network.lua
-- Version of original Luci file git-19.114.27638-3ffdf41
...
-- Added by Inango:
-- Luci shows all interfaces seen in the ifconfig command, i.e. WpEnet, enet0, enet1, st1, ...st16, ct0, ct1, ct0.4096, ct1.4096.
-- Only one interface is a "real" one - WpENET. Other interfaces is tun/taps, and therefore must be ignored.
IFACE_PATTERNS_IGNORE   = { "^wmaster%d", "^wifi%d", "^hwsim%d", "^imq%d", "^ifb%d", "^mon%.wlan%d", "^sit%d", "^gre%d", "^gretap%d", "^ip6gre%d", "^ip6tnl%d", "^tunl%d", "^lo$", "^enet%d", "^st%d", "^ct%d", "^ct%d%.4096$" }
